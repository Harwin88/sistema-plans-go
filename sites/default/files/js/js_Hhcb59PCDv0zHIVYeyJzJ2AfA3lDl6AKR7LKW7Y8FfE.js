...
(function($) {
  ...
  $("#edit-table_wrapper").removeClass('dataTables_wrapper form-inline dt-bootstrap no-footer')
   ...
   $('.valores_operaction').blur(function(){
     $('#valor_real').val(parseFloat($('#valor_programado').val()) + parseFloat($('#valor_adicion').val()));
  });
  $('.value_ejecutado').blur(function(){
  $('#valor_saldo').val(parseFloat($('#valor_real').val()) - parseFloat($('#valor_ejecutado').val()));
